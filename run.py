...
def get_sales_data():
    """
    Get sales figures inpt from the user
    """
    while True:
...
def update_worksheet(data, worksheet):
    """
    Update surplus worksheet, add new row with computed surplus data
    """
...
def get_last_5_sales_entries():
    ...
    5 last entries only for each sandwich and returns the data
    as a list of lists.
    """
...
print("Welcome to love sandwiches Data Automation System!\n")
# main()
